...
const config: NextConfig = {
  ...
  // Next gzips every response, videos included, which drops Content-Length and with it
  // Range support. The proxy/CDN in front compresses text responses instead.
  compress: false,
